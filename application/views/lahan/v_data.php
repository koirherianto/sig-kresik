<div class="content">
    ...
    <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input Data Lahan Tanah Bersertifikat</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="<?= base_url('lahan/edit/'.$value->id_lahan)?>" class="btn btn-sm btn-warning"><i 
                    class="fas fa-edit"></i></a>
                    <a href="<?= base_url('lahan/delete/'.$value->id_lahan)?>" class="btn btn-sm btn-danger" onclick="return confirm
                    ('Apakah Anda Ingin Menghapus Data Ini..?')"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
